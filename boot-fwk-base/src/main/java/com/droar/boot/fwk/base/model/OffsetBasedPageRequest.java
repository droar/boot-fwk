...
public class OffsetBasedPageRequest implements Pageable, Serializable {
  ...
  public Pageable next() {
    return new OffsetBasedPageRequest(Math.toIntExact(getOffset()) + getPageSize(), getPageSize(),
        getSort());
  }

  public OffsetBasedPageRequest previous() {
    return hasPrevious()
        ? new OffsetBasedPageRequest(Math.toIntExact(getOffset()) - getPageSize(), getPageSize(),
            getSort())
        : this;
  }
